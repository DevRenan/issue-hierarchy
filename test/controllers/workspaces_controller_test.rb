...
class WorkspacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workspace" do
    assert_difference("Workspace.count") do
      post workspaces_url, params: { workspace: { description: @workspace.description, name: @workspace.name } }
    end
  ...
  test "should update workspace" do
    patch workspace_url(@workspace), params: { workspace: { description: @workspace.description, name: @workspace.name } }
