...
class AttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attachment" do
    assert_difference("Attachment.count") do
      post attachments_url, params: { attachment: { file_path: @attachment.file_path, issue_id: @attachment.issue_id, name: @attachment.name } }
    end
  ...
  test "should update attachment" do
    patch attachment_url(@attachment), params: { attachment: { file_path: @attachment.file_path, issue_id: @attachment.issue_id, name: @attachment.name } }
